...
while True:
    ...
    while time.time()*1000-initial<inputData.mytime:
        ...
        distanceX = distanceX + velocityX*deltaT + 0.5*accelx*deltaT*deltaT
        distanceY =  distanceY + velocityY*deltaT + 0.5*accely*deltaT*deltaT
        sleep(0.02)
        print sqrt(distanceY*distanceY + distanceX*distanceX)
